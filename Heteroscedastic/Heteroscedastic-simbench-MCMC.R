...
for (type.iter in 1:num.each.type) {
  ...
  save(results.df, results.samples, file = paste0("Heteroscedastic/Heteroscedastic-results/Sim-", type.iter, "-res-MCMC.RData"))
}
...
for (type.iter in 1:num.each.type) {
  ...
  save(results.df, results.samples, file = paste0("Heteroscedastic/Heteroscedastic-results/Bench-", type.iter, "-res-MCMC.RData"))
}
