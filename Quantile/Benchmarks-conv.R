...
# Convergence evaluation for quantile regression benchmarks
...
save(bench.r.hat.df, file = paste0("Quantile/Results/Benchmarks-conv-results-", mcmc.iter, "-", str_pad(seed, 2, pad = "0"), ".Rdata"))
