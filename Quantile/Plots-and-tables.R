...
sim.latex <- paste0("\\begin{table}\n",
                    ...
                    chunk.3, "\\\\ \\bottomrule\n",
                    "\\end{tabular}}\n",
                    "\\caption{Results (mean $\\pm$ SD) across quantile linear regression simulations. Each cell represents thirty repetitions. Settings are organized by order of appearance in the main text.}\n",
                    "\\label{table:quantilesim}\n",
                    "\\end{table}")
...
bench.l1.plot <- bench.l1.cdf %>%
  ...
  ggh4x::facet_grid2(block ~ bench, scales = "free_y", independent = "y",
                     labeller = labeller(bench = as_labeller(c("1" = "IgG",
                                                               "2" = "Engel",
                                                               "3" = "Stack",
                                                               "4" = "Energy")))) +
  scale_x_discrete(labels = c("MCMC" = "ML", "MCMC-S" = "MS", "EP" = "E1", "EP-2D" = "E2", "MFVB" = "MF")) +
...
bench.latex <- paste0("\\begin{table}\n",
                      ...
                      "\\begin{tabular}{@{}ccccccc@{}}\n", 
                      "\\toprule\n",
                      "& IgG & Engel & Stack & IgG & Engel & Stack \\\\ \\midrule\n",
                      "& \\multicolumn{3}{c}{$\\vbeta$ $L^1$ accuracy} & \\multicolumn{3}{c}{$\\kappa$ $L^1$ accuracy} \\\\\n",
                      chunk.1, "\\\\ \\midrule\n",
                      "& \\multicolumn{3}{c}{$M^*$} & \\multicolumn{3}{c}{lppd} \\\\\n",
                      chunk.2, "\\\\ \\midrule\n",
                      ...
                      chunk.3, "\\\\ \\bottomrule\n",
                      "\\end{tabular}}\n",
                      "\\caption{Results (mean $\\pm$ SD) across quantile linear regression benchmarks. Each cell represents thirty repetitions.}\n",
                      "\\label{table:quantilebench}\n",
                      "\\end{table}")
