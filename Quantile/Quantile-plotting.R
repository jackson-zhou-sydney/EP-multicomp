...
ggsave("Quantile/Quantile-plots/Quantile-sim-plot-3.png", sim.plot.3, width = 8, height = 3)
...
ggsave("Quantile/Quantile-plots/Quantile-bench-plot-1.png", bench.plot.1, width = 8, height = 3)
...
ggsave("Quantile/Quantile-plots/Quantile-bench-plot-2.png", bench.plot.2, width = 8, height = 3)
