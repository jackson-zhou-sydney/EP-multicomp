...
sim.plot.1 <- sim.plot.df %>% 
  ...
  facet_wrap(~sim, nrow = num.each.type, scales = "free",
             labeller = as_labeller(c("1" = "Normal (n = 200, p = 40)",
...
ggsave("Quantile/Quantile-plots/Quantile-sim-plot-2.png", sim.plot.2, width = 8, height = 5)
...
ggsave("Quantile/Quantile-plots/Quantile-sim-plot-3.png", sim.plot.3, width = 8, height = 5)
plot_crop("Quantile/Quantile-plots/Quantile-sim-plot-3.png")
...
ggsave("Quantile/Quantile-plots/Quantile-bench-plot-1.png", bench.plot.1, width = 8, height = 5)
plot_crop("Quantile/Quantile-plots/Quantile-bench-plot-1.png")
...
ggsave("Quantile/Quantile-plots/Quantile-bench-plot-2.png", bench.plot.2, width = 8, height = 5)
plot_crop("Quantile/Quantile-plots/Quantile-bench-plot-2.png")
