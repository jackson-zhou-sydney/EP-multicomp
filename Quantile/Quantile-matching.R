...
# Matching for quantile regression
...
ggsave("Quantile/Quantile-plots/Quantile-sim-mplot.png", sim.mplot, width = 8, height = 3)
plot_crop("Quantile/Quantile-plots/Quantile-sim-mplot.png")
