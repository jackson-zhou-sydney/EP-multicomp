...
tuple <vec, mat> h_mom(double y, vec mu, mat Sigma, double eta, int n_grid) {
...
// [[Rcpp::export]]
List ep(mat X_1, mat X_2, vec y, mat Sigma_theta, vec mu_theta,
  ...
  for (int pass = 0; pass < max_passes; ++pass) {
    ...
    #pragma omp parallel
    {
      ...
      for (int k = 0; k < n; ++k) {
        ...
        tuple <vec, mat> h_mom_res = h_mom(y(k), mu_m_star, Sigma_m_star, eta, n_grid);
